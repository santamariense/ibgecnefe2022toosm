SELECT count(*) FROM public.tipos_de_pontos_de_interesse
WHERE substituicoes_aplicadas IS NULL
--LIMIT 100


SELECT * FROM public.tipos_de_pontos_de_interesse
WHERE substituicoes_aplicadas LIKE '%SUPER%'
--LIMIT 100
